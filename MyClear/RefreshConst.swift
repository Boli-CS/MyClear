...
let RefreshHeaderPullToNormal:NSString =  "Cancel Operation"
let RefreshHeaderReleaseToBack:NSString =  "Switch To Homepage"
let RefreshHeaderReleaseToAdd:NSString =  "Add New Item"
